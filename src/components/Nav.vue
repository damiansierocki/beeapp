  ...
  <div class="nav">
    ...
    <div class="nav-left">
      ...
      <div class="nav-left__menu" v-if="showLeftMenu">
        ...
        <router-link class="nav-left__link" to="/">Strona główna</router-link>
        <router-link class="nav-left__link" to="/apiaries">Pasieki</router-link>
        <router-link class="nav-left__link" to="/hives">Ule</router-link>
      </div>
    </div>
    ...
    <div class="nav-right">
      ...
      <div class="nav-right__menu" v-if="showRightMenu">
        ...
        <router-link class="nav-right__link" to="/myaccount"
          ><i class="fas fa-user-circle right-icon"></i>Moje konto</router-link
        >
        ...
        <a class="nav-right__link" @click="logout()"
          ><i class="fas fa-sign-out-alt right-icon"></i>Wyloguj się</a
        >
      </div>
    </div>
  </div>
